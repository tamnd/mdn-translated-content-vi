...
Khi các kiểu nội dung mới được phát minh hoặc được thêm vào máy chủ web, quản trị viên web có thể không thêm các kiểu MIME mới vào cấu hình máy chủ web của họ. Đây là nguồn gốc chính của các vấn đề cho người dùng trình duyệt tôn trọng các kiểu MIME được báo cáo bởi máy chủ web và ứng dụng.
