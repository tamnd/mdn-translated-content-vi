---
title: "RTCIceCandidateStats: thuộc tính timestamp"
...
Thuộc tính **`timestamp`** của từ điển {{domxref("RTCIceCandidateStats")}} là đối tượng {{domxref("DOMHighResTimeStamp")}} chỉ ra thời điểm dữ liệu trong đối tượng được lấy mẫu.
