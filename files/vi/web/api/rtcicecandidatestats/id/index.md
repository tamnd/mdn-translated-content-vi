---
title: "RTCIceCandidateStats: thuộc tính id"
short-title: id
...
Thuộc tính **`id`** của từ điển {{domxref("RTCIceCandidateStats")}} là một chuỗi xác định duy nhất đối tượng mà đối tượng này cung cấp thống kê.
...
Một chuỗi xác định duy nhất đối tượng mà đối tượng `RTCIceCandidateStats` này cung cấp thống kê.
