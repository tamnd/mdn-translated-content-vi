---
title: "GPURenderPassEncoder: phương thức drawIndirect()"
...
Phương thức **`drawIndirect()`** của giao diện {{domxref("GPURenderPassEncoder")}} vẽ các nguyên thủy sử dụng các tham số được đọc từ {{domxref("GPUBuffer")}}.
