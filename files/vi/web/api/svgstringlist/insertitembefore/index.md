...
Phương thức **`insertItemBefore()`** của giao diện {{domxref("SVGStringList")}} chèn một phần tử mới vào danh sách tại vị trí được chỉ định. Phần tử đầu tiên có chỉ mục 0. Phần tử được chèn là chính phần tử đó, không phải bản sao.
...
- Nếu chỉ mục lớn hơn hoặc bằng {{domxref("SVGStringList.length", "length")}}, phần tử mới được thêm vào cuối danh sách.
