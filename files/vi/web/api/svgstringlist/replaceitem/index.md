...
Phương thức **`replaceItem()`** của giao diện {{domxref("SVGStringList")}} thay thế một phần tử hiện có trong danh sách bằng một phần tử mới. Phần tử được chèn là chính phần tử đó, không phải bản sao.
...
- Nếu phần tử đã có trong danh sách này, lưu ý rằng chỉ mục của phần tử cần thay thế là trước khi xóa phần tử.
