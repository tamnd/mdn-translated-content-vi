...
Phương thức **`WebGLRenderingContext.stencilFuncSeparate()`** của [WebGL API](/en-US/docs/Web/API/WebGL_API) thiết lập chức năng mặt trước và/hoặc mặt sau và giá trị tham chiếu cho việc kiểm tra stencil.
...
- `face`
  - : Một {{domxref("WebGL_API/Types", "GLenum")}} xác định trạng thái stencil mặt trước và/hoặc mặt sau là
