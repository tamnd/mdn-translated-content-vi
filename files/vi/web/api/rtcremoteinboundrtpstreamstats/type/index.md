---
title: "RTCRemoteInboundRtpStreamStats: thuộc tính type"
short-title: type
...
Thuộc tính **`type`** của từ điển {{domxref("RTCRemoteInboundRtpStreamStats")}} là một chuỗi có giá trị `"remote-inbound-rtp"`.
...
Giá trị `"inbound-rtp"` cho biết rằng thống kê có sẵn trong bước hiện tại là những thống kê được định nghĩa trong {{domxref("RTCRemoteInboundRtpStreamStats")}}.
