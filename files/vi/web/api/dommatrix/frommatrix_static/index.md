...
Phương thức tĩnh **`fromMatrix()`** của giao diện {{domxref("DOMMatrix")}} tạo một đối tượng {{domxref("DOMMatrix")}} mới từ một ma trận hiện có hoặc một đối tượng cung cấp các giá trị cho các thuộc tính của nó.
