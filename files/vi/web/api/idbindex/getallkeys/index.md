...
Phương thức **`getAllKeys()`** của giao diện `IDBIndex` trả về tất cả khóa khớp trong object store được tham chiếu tương ứng với khóa đã cho hoặc nằm trong phạm vi, nếu `key` là một {{domxref("IDBKeyRange")}}.
