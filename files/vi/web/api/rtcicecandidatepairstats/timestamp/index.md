...
Thuộc tính **`timestamp`** của từ điển {{domxref("RTCIceCandidatePairStats")}} là đối tượng {{domxref("DOMHighResTimeStamp")}} xác định thời điểm dữ liệu trong đối tượng được lấy mẫu.
