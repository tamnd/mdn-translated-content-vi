...
Thuộc tính **`id`** của từ điển {{domxref("RTCIceCandidatePairStats")}} là một chuỗi xác định duy nhất đối tượng mà đối tượng này cung cấp thống kê.
...
Một chuỗi xác định duy nhất đối tượng mà đối tượng `RTCIceCandidatePairStats` này cung cấp thống kê.
