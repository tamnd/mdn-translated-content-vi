...
Thuộc tính **`orientationZ`** của giao diện {{ domxref("PannerNode") }}
cho biết thành phần Z (chiều sâu) của hướng mà nguồn âm thanh đang hướng đến, trong không gian tọa độ Descartes 3D.
...
Một {{domxref("AudioParam")}} có `value` là thành phần Z của
