...
Thuộc tính chỉ đọc cũ **`PerformanceTiming.domainLookupStart`**
trả về một `unsigned long long` biểu diễn thời điểm,
tính bằng mili giây kể từ kỷ nguyên UNIX, quá trình tra cứu tên miền bắt đầu. Nếu kết nối
liên tục được sử dụng, hoặc thông tin được lưu trong bộ nhớ đệm hoặc tài nguyên cục bộ,
