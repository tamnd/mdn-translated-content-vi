...
Sự kiện `removetrack` được kích hoạt khi một video track bị xóa khỏi [`VideoTrackList`](/en-US/docs/Web/API/VideoTrackList).
...
- {{domxref("TrackEvent.track", "track")}} {{ReadOnlyInline}}
  - : {{domxref("VideoTrack")}} mới bị xóa mà sự kiện đề cập đến.
...
- Sự kiện này trên mục tiêu [`AudioTrackList`](/en-US/docs/Web/API/AudioTrackList): [`removetrack`](/en-US/docs/Web/API/AudioTrackList/removetrack_event)
- Sự kiện này trên mục tiêu [`MediaStream`](/en-US/docs/Web/API/MediaStream): [`removetrack`](/en-US/docs/Web/API/MediaStream/removetrack_event)
