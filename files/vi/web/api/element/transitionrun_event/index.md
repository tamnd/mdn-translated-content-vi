...
Thuộc tính **`transitionrun`** is fired when a [CSS transition](/en-US/docs/Web/CSS/Guides/Transitions/Sử dụng) is first created, i.e., before any {{cssxref("transition-delay")}} has begun.
