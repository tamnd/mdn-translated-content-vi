...
Thuộc tính **`keydown`** is fired when a key is pressed.
...
Ví dụ này logs the {{domxref("KeyboardEvent.code")}} value whenever you press down a key inside the {{HtmlElement("input")}} element.
