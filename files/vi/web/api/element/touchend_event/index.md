...
Một {{domxref("TouchEvent")}}. Inherits from {{domxref("Event")}}.
...
- {{domxref("TouchEvent.changedTouches")}} {{ReadOnlyInline}}
  - : Một {{domxref("TouchList")}} of all the {{domxref("Touch")}} objects representing individual points of contact whose states changed between the previous touch event and this one.
...
- {{domxref("TouchEvent.targetTouches")}} {{ReadOnlyInline}}
  - : Một {{domxref("TouchList")}} of all the {{domxref("Touch")}} objects that are both currently in contact with the touch surface **and** were also started on the same element that is the target of the event.
- {{domxref("TouchEvent.touches")}} {{ReadOnlyInline}}
  - : Một {{domxref("TouchList")}} of all the {{domxref("Touch")}} objects representing all current points of contact with the surface, regardless of target or changed status.
