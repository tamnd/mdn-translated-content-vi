---
title: "HTMLTableSectionElement: phương thức deleteRow()"
...
Phương thức **`deleteRow()`** của giao diện {{domxref("HTMLTableSectionElement")}} xóa một hàng cụ thể ({{HtmlElement("tr")}}) khỏi một {{HtmlElement("section")}} đã cho.
