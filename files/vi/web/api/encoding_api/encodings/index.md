...
Các hàm khởi tạo của các giao diện [Encoding API](/en-US/docs/Web/API/Encoding_API) {{domxref("TextDecoder")}} và {{domxref("TextDecoderStream")}} có thể nhận một đối số tùy chọn `label`, đối số này xác định mã hóa sẽ được sử dụng.

Bảng sau liệt kê tất cả các nhãn mã hóa mà user agent phải hỗ trợ, cùng với mã hóa mà nhãn đó biểu thị. Lưu ý rằng hầu hết các mã hóa đều có nhiều hơn một nhãn.
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        <code>"iso_8859-9"</code>, <code>"iso_8859-9:1989"</code>, <code>"l5"</code>,
        <code>"latin5"</code>, <code>"windows-1254"</code>, <code>"x-cp1254"</code>
      </td>
      <td>
    ...
    <tr>
      <td>
        <code>"x-mac-cyrillic"</code>, <code>"x-mac-ukrainian"</code>,
        <code>"x-user-defined"</code>
      </td>
      <td>
        <a href="https://en.wikipedia.org/wiki/MacCyrillic">x-mac-cyrillic</a>
      </td>
    </tr>
    <tr>
      <td>
