---
title: "VRDisplay: thuộc tính depthNear"
...
Thuộc tính **`depthNear`** của giao diện {{domxref("VRDisplay")}} dùng để lấy và đặt độ sâu z xác định mặt phẳng gần của [khối nhìn mắt](https://en.wikipedia.org/wiki/Viewing_frustum), tức là ranh giới nhìn thấy gần nhất của cảnh.
...
Thông thường bạn nên để nguyên giá trị mặc định, nhưng có thể muốn tăng nó nếu bạn đang cố cải thiện hiệu suất trên các máy tính chậm hơn, và/hoặc giao diện người dùng của bạn phù hợp hơn khi ranh giới gần được đặt xa hơn.

## Giá trị

Một số double, đại diện cho độ sâu z tính bằng mét; giá trị khởi tạo là `0.01`.
