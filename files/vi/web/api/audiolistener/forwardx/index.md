---
title: "AudioListener: thuộc tính forwardX"
...
Thuộc tính chỉ đọc `forwardX` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn giá trị x của vector hướng xác định hướng tiến về phía trước mà listener đang hướng tới.
