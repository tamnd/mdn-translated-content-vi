---
title: "AudioListener: thuộc tính forwardZ"
...
Thuộc tính chỉ đọc `forwardZ` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn giá trị z của vector hướng xác định hướng tiến về phía trước mà listener đang hướng tới.
