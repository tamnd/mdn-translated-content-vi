---
title: "AudioListener: thuộc tính positionY"
...
Thuộc tính chỉ đọc `positionY` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn vị trí y của listener trong không gian Descartes 3D.
