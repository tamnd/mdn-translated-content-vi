---
title: "AudioListener: thuộc tính upX"
short-title: upX
...
Thuộc tính chỉ đọc `upX` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn giá trị x của vector hướng xác định hướng lên trên mà listener đang hướng tới.
...
Để xem mã ví dụ chi tiết hơn, hãy xem [`BaseAudioContext.createPanner()`](/en-US/docs/Web/API/BaseAudioContext/createPanner#examples).
