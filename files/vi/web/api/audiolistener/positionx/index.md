---
title: "AudioListener: thuộc tính positionX"
...
Thuộc tính chỉ đọc `positionX` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn vị trí x của listener trong không gian Descartes 3D.
