---
title: "AudioListener: thuộc tính upZ"
short-title: upZ
...
Thuộc tính chỉ đọc `upZ` của giao diện {{ domxref("AudioListener") }} là một {{domxref("AudioParam")}} biểu diễn giá trị z của vector hướng xác định hướng lên trên mà listener đang hướng tới.
