...
`textureWidth` của một layer hữu ích khi tạo render buffer cho một layer. Xem thêm {{domxref("WebGL2RenderingContext.renderbufferStorageMultisample()")}}.
