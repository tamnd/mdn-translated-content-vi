---
title: "IDBKeyRange: thuộc tính lower"
short-title: lower
...
Thuộc tính chỉ đọc **`lower`** của giao diện {{domxref("IDBKeyRange")}} trả về giới hạn dưới của phạm vi khóa.

## Giá trị

Giới hạn dưới của phạm vi khóa, có thể là bất kỳ kiểu nào.
...
Sau khi khai báo phạm vi khóa, chúng ta ghi giá trị thuộc tính `lower` của nó ra console; kết quả nên là `"F"`.
