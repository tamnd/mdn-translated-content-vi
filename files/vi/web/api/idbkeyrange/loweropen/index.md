---
title: "IDBKeyRange: thuộc tính lowerOpen"
...
Thuộc tính chỉ đọc **`lowerOpen`** của giao diện {{domxref("IDBKeyRange")}} trả về một giá trị boolean cho biết giá trị ở giới hạn dưới có được bao gồm trong phạm vi khóa hay không.
...
| Giá trị | Ý nghĩa                                                        |
| ------- | -------------------------------------------------------------- |
| `true`  | Giá trị ở giới hạn dưới không được bao gồm trong phạm vi khóa. |
| `false` | Giá trị ở giới hạn dưới được bao gồm trong phạm vi khóa.       |
...
Sau khi khai báo phạm vi khóa, chúng ta ghi giá trị thuộc tính `lowerOpen` của nó ra console; kết quả nên là `"true"`: giới hạn dưới là mở nên sẽ không được bao gồm trong phạm vi.
