...
Phương thức tĩnh **`fromFloat64Array()`** của giao diện {{domxref("DOMMatrixReadOnly")}} tạo một đối tượng {{domxref("DOMMatrixReadOnly")}} mới từ một mảng các giá trị số thực dấu phẩy động độ chính xác kép (64-bit).
