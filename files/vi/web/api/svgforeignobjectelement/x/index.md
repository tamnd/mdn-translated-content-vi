...
Chúng ta có thể truy cập các giá trị tính toán của thuộc tính `x`:
...
console.dir(xObject2.baseVal.value); // output: 50 (25% của 200)
```
