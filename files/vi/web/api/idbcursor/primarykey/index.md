---
title: "IDBCursor: thuộc tính primaryKey"
...
Thuộc tính chỉ đọc **`primaryKey`** của giao diện {{domxref("IDBCursor")}} trả về khóa hiệu lực hiện tại của con trỏ. Nếu con trỏ đang được di chuyển hoặc đã duyệt ra ngoài phạm vi, giá trị này được đặt là `undefined`. Khóa chính của con trỏ có thể là bất kỳ kiểu dữ liệu nào.
