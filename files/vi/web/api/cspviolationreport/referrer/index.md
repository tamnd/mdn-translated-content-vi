...
Thuộc tính **`referrer`** của từ điển {{domxref("CSPViolationReport")}} là một chuỗi đại diện cho URL của trang tham chiếu của tài nguyên có [Chính sách bảo mật nội dung (CSP)](/en-US/docs/Web/HTTP/Guides/CSP) bị vi phạm.
