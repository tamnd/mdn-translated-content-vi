---
title: Giá trị code cho sự kiện bàn phím
...
"(⚠️ Not the same on xyz)" có nghĩa là chuỗi này đại diện cho giá trị code khác trên trình duyệt xyz và cần đặc biệt chú ý
khi sử dụng nó.
