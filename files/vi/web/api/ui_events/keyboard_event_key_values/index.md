---
title: Giá trị key cho sự kiện bàn phím
...
Các bảng dưới đây liệt kê các giá trị chuẩn cho thuộc tính [`KeyboardEvent.key`](/en-US/docs/Web/API/KeyboardEvent/key), kèm giải thích về mục đích thông thường của phím. Mã phím ảo tương ứng cho các nền tảng phổ biến được bao gồm khi có sẵn.

## Giá trị đặc biệt

Các giá trị của `key` có ý nghĩa đặc biệt khác với việc xác định một phím hoặc ký tự cụ thể.
...
_Phím điều chỉnh_ là các phím đặc biệt được dùng để tạo ký tự đặc biệt hoặc gây ra các hành động đặc biệt khi được sử dụng kết hợp với các phím khác. Ví dụ bao gồm các phím <kbd>Shift</kbd> và <kbd>Control</kbd>, và các phím khóa như <kbd>Caps Lock</kbd> và <kbd>NumLock</kbd>.
...
## Phím IME và soạn thảo

Các phím được dùng khi sử dụng {{glossary("Input Method Editor")}} (IME) để nhập văn bản không thể dễ dàng nhập bằng cách nhấn phím đơn giản, chẳng hạn như văn bản trong các ngôn ngữ có nhiều grapheme hơn số phím nhập ký tự trên bàn phím. Ví dụ phổ biến bao gồm tiếng Trung, tiếng Nhật, tiếng Hàn và tiếng Hindi.
...
Trong khi các nền tảng khác nhau hỗ trợ số lượng phím chức năng đa dụng khác nhau, chẳng hạn như <kbd>F1</kbd>–<kbd>F12</kbd> (hoặc <kbd>F1</kbd>–<kbd>F10</kbd>, hoặc <kbd>F1</kbd>–<kbd>F15</kbd>, v.v.), một vài phím đầu tiên được định nghĩa cụ thể như sau.
...
Các phím này đại diện cho các nút thường có trên điện thoại thông minh hiện đại.
...
Các phím đa phương tiện là các nút hoặc phím bổ sung để điều khiển thiết bị phương tiện, được tìm thấy trên một số bàn phím.
...
## Phím điều khiển âm thanh

Các phím phương tiện này được dùng đặc biệt để điều khiển âm thanh.
...
Các giá trị phím này đại diện cho các nút hoặc phím có trên thiết bị truyền hình, hoặc máy tính hoặc điện thoại có hỗ trợ TV.
...
## Phím điều khiển phương tiện

Vì điều khiển từ xa hiện đại cho thiết bị phương tiện thường bao gồm các nút ngoài các điều khiển cơ bản được đề cập ở nơi khác trong tài liệu này, các giá trị phím được xác định cho nhiều loại nút bổ sung này.
...
## Phím nhận dạng giọng nói

Các phím đa phương tiện đặc biệt này được dùng để điều khiển các tính năng nhận dạng giọng nói.
...
Các phím này điều khiển tài liệu. Trong đặc tả, chúng được bao gồm trong các tập phím khác (như phím phương tiện), nhưng chúng được coi hợp lý hơn là thuộc danh mục riêng.
...
Một số bàn phím cung cấp các phím đặc biệt để khởi chạy hoặc chuyển sang một số ứng dụng phổ biến. Các giá trị phím cho những phím đó được liệt kê ở đây.
...
## Phím điều khiển trình duyệt

Một số bàn phím bao gồm các phím đặc biệt để điều khiển trình duyệt Web. Các phím đó theo sau đây.
...
Các phím này được tìm thấy trên bàn phím số của bàn phím. Tuy nhiên, không phải tất cả đều có mặt trên mọi bàn phím. Mặc dù bàn phím số thông thường có các phím số từ <kbd>0</kbd> đến <kbd>9</kbd> (được mã hóa là `"0"` đến `"9"`), một số bàn phím đa phương tiện bao gồm các phím số bổ sung cho số cao hơn.
