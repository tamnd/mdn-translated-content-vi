---
title: "RTCRemoteOutboundRtpStreamStats: thuộc tính id"
short-title: id
...
Thuộc tính **`id`** của từ điển {{domxref("RTCRemoteOutboundRtpStreamStats")}} là một chuỗi nhận dạng duy nhất đối tượng mà đối tượng này cung cấp thống kê.
...
Chuỗi nhận dạng duy nhất đối tượng mà đối tượng `RTCRemoteOutboundRtpStreamStats` này cung cấp thống kê.
