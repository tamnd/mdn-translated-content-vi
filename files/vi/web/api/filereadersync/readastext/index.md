---
title: "FileReaderSync: Phương thức readAsText()"
...
- `encoding` {{optional_inline}}
  - : Tham số tùy chọn chỉ định bảng mã sẽ sử dụng (ví dụ: `iso-8859-1` hoặc `UTF-8`). Nếu không có, phương thức sẽ áp dụng thuật toán tự động phát hiện.
