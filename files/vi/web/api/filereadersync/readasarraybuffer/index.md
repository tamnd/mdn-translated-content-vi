---
title: "FileReaderSync: Phương thức readAsArrayBuffer()"
...
- `blob`
  - : Đối tượng {{DOMxRef("File")}} hoặc {{DOMxRef("Blob")}} cần đọc vào {{DOMxRef("File")}} hoặc {{jsxref("ArrayBuffer")}}.

### Giá trị trả về

Một {{jsxref("ArrayBuffer")}} biểu diễn dữ liệu của tệp.
