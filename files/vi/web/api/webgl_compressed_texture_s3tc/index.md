---
title: Tiện ích WEBGL_compressed_texture_s3tc
...
Tiện ích **`WEBGL_compressed_texture_s3tc`** là một phần của [WebGL API](/en-US/docs/Web/API/WebGL_API) và cung cấp bốn [định dạng texture nén S3TC](https://en.wikipedia.org/wiki/S3_Texture_Compression).
