---
title: "AudioWorkletGlobalScope: thuộc tính sampleRate"
...
Thuộc tính chỉ đọc **`sampleRate`** của giao diện {{domxref("AudioWorkletGlobalScope")}} trả về một số thực float biểu thị tốc độ lấy mẫu của {{domxref("BaseAudioContext")}} liên kết mà worklet thuộc về.
