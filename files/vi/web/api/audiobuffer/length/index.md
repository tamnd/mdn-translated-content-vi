---
title: "AudioBuffer: thuộc tính length"
short-title: length
...
Thuộc tính **`length`** của giao diện {{ domxref("AudioBuffer") }} trả về một số nguyên biểu diễn độ dài, tính theo khung mẫu, của dữ liệu PCM được lưu trong bộ đệm.
