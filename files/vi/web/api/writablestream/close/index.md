---
title: "WritableStream: phương thức close()"
short-title: close()
...
Phương thức **`close()`** của giao diện {{domxref("WritableStream")}} sẽ đóng luồng liên kết. Tất cả các đoạn được viết trước khi phương thức này được gọi sẽ được gửi trước khi lời hứa trả lại được thực hiện.

Điều này tương đương với việc nhận {{domxref("WritableStreamDefaultWriter")}} với {{domxref("WritableStream.getWriter()", "getWriter()")}}, gọi {{domxref("WritableStreamDefaultWriter.close()", "close()")}} trên đó.
