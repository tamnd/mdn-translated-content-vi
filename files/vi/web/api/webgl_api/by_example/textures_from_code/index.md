...
Ví dụ về WebGL này cung cấp một minh họa đơn giản về kết cấu thủ tục với các trình đổ bóng phân đoạn. Nghĩa là, sử dụng mã để tạo họa tiết để sử dụng trong việc tạo bóng cho các đối tượng WebGL.

## Vẽ họa tiết bằng mã

{{EmbedLiveSample("Drawing_textures_with_code", 660, 425)}}

Tạo họa tiết cho một điểm với các phép tính được thực hiện trên mỗi pixel trong trình đổ bóng phân đoạn.
...
Mã nguồn của ví dụ này cũng có trên [GitHub](https://github.com/idofilin/webgl-by-example/tree/master/textures-from-code).
