---
title: Tiện ích WEBGL_compressed_texture_astc
...
Tiện ích **`WEBGL_compressed_texture_astc`** là một phần của [WebGL API](/en-US/docs/Web/API/WebGL_API) và cung cấp các định dạng texture nén [Adaptive Scalable Texture Compression](https://en.wikipedia.org/wiki/Adaptive_Scalable_Texture_Compression) (ASTC) cho WebGL.

Để biết thêm thông tin, xem bài viết [Using ASTC Texture Compression for Game Assets](https://developer.nvidia.com/astc-texture-compression-for-game-assets) của NVIDIA.
...
> [!NOTE]
> Nén ASTC thường khả dụng trên GPU Mali ARM, GPU Intel và chip NVIDIA Tegra.
>
...
Các định dạng texture nén được cung cấp bởi 28 hằng số và có thể được dùng trong hai hàm: {{domxref("WebGLRenderingContext.compressedTexImage2D", "compressedTexImage2D()")}} và {{domxref("WebGLRenderingContext.compressedTexSubImage2D", "compressedTexSubImage2D()")}}.
...
<table class="no-markdown">
  <thead>
    <tr>
      ...
      <th>Byte khi chiều cao và rộng là 512</th>
    </tr>
  </thead>
  <tbody>
    <tr>
