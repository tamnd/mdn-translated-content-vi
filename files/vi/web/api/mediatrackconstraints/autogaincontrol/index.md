...
Thuộc tính **`autoGainControl`** của từ điển {{domxref("MediaTrackConstraints")}} là [`ConstrainBoolean`](/en-US/docs/Web/API/MediaTrackConstraints#constrainboolean) mô tả các ràng buộc được yêu cầu hoặc bắt buộc đặt lên giá trị của thuộc tính có thể ràng buộc {{domxref("MediaTrackSettings.autoGainControl", "autoGainControl")}}.
