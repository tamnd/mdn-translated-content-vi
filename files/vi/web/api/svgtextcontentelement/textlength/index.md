...
Thuộc tính chỉ đọc **`textLength`** của giao diện {{domxref("SVGTextContentElement")}} phản ánh thuộc tính {{SVGAttr("textLength")}} của phần tử đã cho.
...
### Truy cập thuộc tính `textLength`
