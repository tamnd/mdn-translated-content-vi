---
title: "OscillatorNode: thuộc tính frequency"
...
Thuộc tính **`frequency`** của giao diện {{ domxref("OscillatorNode") }} là một {{domxref("AudioParam")}} [a-rate](/en-US/docs/Web/API/AudioParam#a-rate) đại diện cho tần số dao động tính bằng hertz.
