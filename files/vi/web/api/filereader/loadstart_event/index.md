---
title: "FileReader: sự kiện loadstart"
...
Sự kiện **`loadstart`** của giao diện {{domxref("FileReader")}} được kích hoạt khi thao tác đọc tệp bắt đầu.
...
- Sự kiện liên quan: {{domxref("FileReader.loadend_event", "loadend")}}, {{domxref("FileReader.load_event", "load")}}, {{domxref("FileReader.progress_event", "progress")}}, {{domxref("FileReader.error_event", "error")}}, {{domxref("FileReader.abort_event", "abort")}}
