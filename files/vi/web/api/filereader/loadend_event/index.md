---
title: "FileReader: sự kiện loadend"
short-title: loadend
...
Sự kiện **`loadend`** của giao diện {{domxref("FileReader")}} được kích hoạt khi thao tác đọc tệp hoàn tất, dù thành công hay không.
...
- Sự kiện liên quan: {{domxref("FileReader.loadstart_event", "loadstart")}}, {{domxref("FileReader.load_event", "load")}}, {{domxref("FileReader.progress_event", "progress")}}, {{domxref("FileReader.error_event", "error")}}, {{domxref("FileReader.abort_event", "abort")}}
