...
Thuộc tính **`ariaValueMin`** của giao diện {{domxref("ElementInternals")}} phản ánh giá trị của thuộc tính [`aria-valuemin`](/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-valuemin), xác định giá trị tối thiểu được phép cho widget phạm vi.
...
Trong ví dụ này, giá trị của `ariaValueMin` được đặt thành "10".
