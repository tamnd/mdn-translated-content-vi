...
Thuộc tính **`ariaRowSpan`** của giao diện {{domxref("ElementInternals")}} phản ánh giá trị của thuộc tính [`aria-rowspan`](/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-rowspan), xác định số hàng được kéo dài bởi một ô hoặc gridcell trong bảng, lưới hoặc treegrid.
...
Trong ví dụ này, giá trị của `ariaRowSpan` được đặt thành "2".
