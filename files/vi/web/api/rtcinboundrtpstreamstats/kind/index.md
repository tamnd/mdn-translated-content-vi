---
title: "RTCInboundRtpStreamStats: thuộc tính kind"
short-title: kind
...
Thuộc tính **`kind`** của từ điển {{domxref("RTCInboundRtpStreamStats")}} là một chuỗi chỉ ra liệu luồng {{Glossary("RTP")}} được mô tả chứa media âm thanh hay video.
