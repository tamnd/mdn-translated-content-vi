---
title: "RTCInboundRtpStreamStats: thuộc tính ssrc"
short-title: ssrc
...
Thuộc tính **`ssrc`** của từ điển {{domxref("RTCInboundRtpStreamStats")}} xác định nguồn đồng bộ hóa (SSRC) của luồng gói {{Glossary("RTP")}} này.
...
Thuộc tính **`ssrc`** xác định duy nhất SSRC của các gói RTP được bao phủ bởi đối tượng {{domxref("RTCInboundRtpStreamStats")}} này.

Nguồn đồng bộ hóa có thể là thứ gì đó như micro, hoặc ứng dụng mixer kết hợp nhiều nguồn.
