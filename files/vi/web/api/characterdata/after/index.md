---
title: "CharacterData: phương thức after()"
short-title: after()
...
Phương thức **`after()`** của giao diện {{domxref("CharacterData")}}
chèn một tập các đối tượng {{domxref("Node")}} hoặc chuỗi vào danh sách phần tử con của
...
> phương thức [`appendData()`](/en-US/docs/Web/API/CharacterData/appendData) cho phép bạn nối vào dữ liệu của nút hiện tại.
