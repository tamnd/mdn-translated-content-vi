...
Thuộc tính chỉ đọc **`selectionStart`** của {{domxref("EditContext")}} tham chiếu đến độ lệch, trong nội dung văn bản có thể chỉnh sửa, của điểm bắt đầu vùng chọn hiện tại.
...
### Dùng `selectionStart` để hiển thị vùng chọn người dùng trong canvas có thể chỉnh sửa
