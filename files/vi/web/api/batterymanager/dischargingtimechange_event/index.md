---
title: "BatteryManager: sự kiện dischargingtimechange"
...
Sự kiện **`dischargingtimechange`** của giao diện {{domxref("BatteryManager")}} được kích hoạt khi thuộc tính {{domxref("BatteryManager.dischargingTime", "dischargingTime")}} của pin được cập nhật.
