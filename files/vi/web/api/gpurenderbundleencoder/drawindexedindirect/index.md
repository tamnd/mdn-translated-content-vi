---
title: "GPURenderBundleEncoder: phương thức drawIndexedIndirect()"
...
Phương thức **`drawIndexedIndirect()`** của giao diện {{domxref("GPURenderBundleEncoder")}} vẽ các nguyên thủy có chỉ mục sử dụng các tham số được đọc từ {{domxref("GPUBuffer")}}.

> [!NOTE]
> Phương thức này về mặt chức năng giống hệt với phương thức tương đương trên {{domxref("GPURenderPassEncoder")}} — {{domxref("GPURenderPassEncoder.drawIndexedIndirect", "drawIndexedIndirect()")}}.
