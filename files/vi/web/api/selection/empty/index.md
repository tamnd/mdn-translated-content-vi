---
title: "Selection: phương thức empty()"
short-title: empty()
...
Phương thức **`Selection.empty()`** xóa tất cả các range khỏi vùng chọn, để các thuộc tính {{domxref("Selection.anchorNode", "anchorNode")}} và {{domxref("Selection.focusNode","focusNode")}} trở thành `null` và không còn gì được chọn. Khi phương thức này được gọi, một sự kiện {{domxref("Document/selectionchange_event", "selectionchange")}} sẽ được phát ra trên tài liệu.

> [!NOTE]
> Phương thức này là bí danh của phương thức {{domxref("Selection.removeAllRanges()")}}.
