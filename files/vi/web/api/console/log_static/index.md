---
title: "console: phương thức tĩnh log()"
short-title: log()
...
Phương thức tĩnh **`console.log()`** xuất một thông báo ra console.
...
- [Tài liệu của Microsoft Edge về `console.log()`](https://learn.microsoft.com/en-us/microsoft-edge/devtools/console/api#log)
- [Tài liệu của Node.js về `console.log()`](https://nodejs.org/docs/latest/api/console.html#consolelogdata-args)
- [Tài liệu của Google Chrome về `console.log()`](https://developer.chrome.com/docs/devtools/console/api/#log)
