---
title: "console: phương thức tĩnh debug()"
short-title: debug()
...
Phương thức tĩnh **`console.debug()`** xuất một thông báo ra console ở mức nhật ký "debug". Thông báo chỉ được hiển thị cho người dùng nếu console được cấu hình để hiển thị đầu ra debug. Trong hầu hết trường hợp, mức nhật ký được cấu hình trong giao diện console. Mức nhật ký này có thể tương ứng với mức `Debug` hoặc `Verbose`.
...
- [Tài liệu của Microsoft Edge về `console.debug()`](https://learn.microsoft.com/en-us/microsoft-edge/devtools/console/api#debug)
- [Tài liệu của Node.js về `console.debug()`](https://nodejs.org/docs/latest/api/console.html#consoledebugdata-args)
- [Tài liệu của Google Chrome về `console.debug()`](https://developer.chrome.com/docs/devtools/console/api/#debug)
