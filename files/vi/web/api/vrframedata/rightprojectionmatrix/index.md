...
Thuộc tính chỉ đọc **`rightProjectionMatrix`** của giao diện {{domxref("VRFrameData")}} trả về một {{jsxref("Float32Array")}} đại diện cho ma trận 4x4 mô tả phép chiếu dùng để kết xuất mắt phải.
