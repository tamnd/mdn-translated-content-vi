...
Thuộc tính chỉ đọc **`rightViewMatrix`** của giao diện {{domxref("VRFrameData")}} trả về một {{jsxref("Float32Array")}} đại diện cho ma trận 4x4 mô tả biến đổi góc nhìn dùng để kết xuất mắt phải.
