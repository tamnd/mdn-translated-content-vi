---
title: "SVGGeometryElement: phương thức isPointInFill()"
...
Phương thức **`isPointInFill()`** của giao diện {{domxref("SVGGeometryElement")}} xác định xem một điểm cho trước có nằm trong vùng tô màu của một phần tử hay không. Tham số `point` được hiểu là một điểm trong hệ tọa độ cục bộ của phần tử.
...
Một giá trị boolean cho biết liệu điểm cho trước có nằm trong vùng tô màu hay không.
