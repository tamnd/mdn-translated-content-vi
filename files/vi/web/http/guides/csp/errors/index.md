...
Khi bạn thấy bất kỳ thông báo nào sau đây được ghi lại trong bảng điều khiển devtools của trình duyệt, điều đó cho biết rằng đã xảy ra sự cố liên quan đến [CSP](/en-US/docs/Web/HTTP/Guides/CSP).
...
- Header HTTP {{HTTPHeader("Content-Security-Policy")}}
