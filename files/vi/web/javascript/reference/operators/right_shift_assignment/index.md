...
Toán tử **right shift assignment (`>>=`)** thực hiện phép [dịch phải](/en-US/docs/Web/JavaScript/Reference/Operators/Right_shift) trên hai toán hạng và gán kết quả cho toán hạng bên trái.
...
### Sử dụng right shift assignment
