...
Phương thức **`getInt32()`** của các instance {{jsxref("DataView")}} đọc 4 byte bắt đầu tại độ lệch byte được chỉ định của `DataView` này và diễn giải chúng như một số nguyên có dấu 32-bit. Không có ràng buộc căn chỉnh; các giá trị nhiều byte có thể được lấy từ bất kỳ độ lệch nào trong giới hạn.
