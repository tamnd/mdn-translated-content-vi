...
Phần tử **`<data>`** trong [HTML](/en-US/docs/Web/HTML) liên kết một đoạn nội dung nhất định với bản dịch có thể đọc được bởi máy. Nếu nội dung liên quan đến thời gian hoặc ngày tháng, phải sử dụng phần tử {{HTMLElement("time")}}.
...
- `value`
  - : Thuộc tính này chỉ định bản dịch có thể đọc được bởi máy của nội dung của phần tử.

## Ví dụ

Ví dụ sau hiển thị tên sản phẩm nhưng cũng liên kết từng tên với một số sản phẩm.
