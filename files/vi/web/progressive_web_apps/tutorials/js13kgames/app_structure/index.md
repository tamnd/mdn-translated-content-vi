...
Dữ liệu game có trong thư mục data dưới dạng một đối tượng JavaScript ([games.js](https://github.com/mdn/pwa-examples/blob/main/js13kpwa/data/games.js)):
...
Mỗi mục có ảnh riêng trong thư mục data/img. Đây là nội dung của chúng ta, được nạp vào phần content bằng JavaScript.

## Bước tiếp theo

Trong bài viết tiếp theo chúng ta sẽ xem kỹ hơn cách app shell và nội dung được cache để dùng ngoại tuyến với sự trợ giúp của service worker.
