...
Thuộc tính **`k4`** định nghĩa một trong các giá trị được dùng trong phép toán `arithmetic` của primitive bộ lọc {{SVGElement("feComposite")}}.

Việc kết hợp pixel được tính theo công thức sau:
