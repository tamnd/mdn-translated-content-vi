...
Thuộc tính **`x1`** được dùng để chỉ định tọa độ x thứ nhất cho việc vẽ một phần tử SVG cần nhiều hơn một tọa độ. Những phần tử chỉ cần một tọa độ sẽ dùng thuộc tính {{SVGAttr("x")}} thay thế.
...
Với {{SVGElement('line')}}, `x1` xác định tọa độ x của điểm bắt đầu của đường thẳng.
...
Với {{SVGElement('linearGradient')}}, `x1` xác định tọa độ x của điểm bắt đầu của _vector gradient_ dùng để ánh xạ các giá trị điểm dừng gradient. Hành vi chính xác của thuộc tính này bị ảnh hưởng bởi thuộc tính {{SVGAttr('gradientUnits')}}.
...
<svg viewBox="0 0 20 10" xmlns="http://www.w3.org/2000/svg">
  <!--
  Theo mặc định, vector gradient bắt đầu ở giới hạn
  ...
  <!--
  Ở đây vector gradient bắt đầu ở 80% của giới hạn
  bên trái của hộp giới hạn của hình dạng mà nó được áp dụng.
  -->
