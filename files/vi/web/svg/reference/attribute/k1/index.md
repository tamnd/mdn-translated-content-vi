---
title: k1
slug: Web/SVG/Reference/Attribute/k1
page-type: svg-attribute
browser-compat: svg.elements.feComposite.k1
sidebar: svgref
---

Thuộc tính **`k1`** xác định một trong các giá trị được dùng trong thao tác `arithmetic` của filter primitive {{SVGElement("feComposite")}}.
