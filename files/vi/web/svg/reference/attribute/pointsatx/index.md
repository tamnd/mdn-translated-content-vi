...
Thuộc tính **`pointsAtX`** biểu thị vị trí x trong hệ tọa độ được thiết lập bởi thuộc tính {{SVGAttr("primitiveUnits")}} trên phần tử {{SVGElement("filter")}} tại điểm mà nguồn sáng đang hướng tới.
