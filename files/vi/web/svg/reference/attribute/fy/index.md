...
Thuộc tính **`fy`** xác định tọa độ trục y của tiêu điểm cho một radial gradient.
...
<table class="properties">
  <tbody>
    ...
    <tr>
      ...
      <td>
        Trùng với giá trị trình bày của {{SVGAttr("cy")}} cho phần tử, bất kể giá trị của <code>cy</code> có được kế thừa hay không.
      </td>
    </tr>
    <tr>
