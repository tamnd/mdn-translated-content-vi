...
Thuộc tính **`font-variant`** cho biết văn bản sẽ được hiển thị bằng các biến thể của các {{Glossary("glyph", "glyph")}} của phông chữ hay không.

> [!NOTE]
> Với vai trò là một presentation attribute, `font-variant` cũng có thuộc tính CSS tương ứng: {{cssxref("font-variant")}}. Khi cả hai đều được chỉ định, thuộc tính CSS sẽ được ưu tiên.
...
Để biết mô tả về các giá trị, vui lòng tham khảo thuộc tính [CSS `font-variant`](/en-US/docs/Web/CSS/Reference/Properties/font-variant#values).
...
- Thuộc tính CSS {{cssxref("font-variant")}}
