...
Thuộc tính [CSS](/en-US/docs/Web/CSS) **`corner-start-end-shape`** chỉ định hình dạng của góc block-start và inline-end của một hộp, trong phạm vi vùng {{cssxref("border-radius")}} của nó.
...
Thuộc tính `corner-start-end-shape` được chỉ định bằng giá trị {{cssxref("&lt;corner-shape-value>")}}.
...
### Cách dùng cơ bản của `corner-start-end-shape`
...
Chúng ta cho hộp một số kiểu dáng cơ bản, được ẩn để ngắn gọn. Chúng ta cũng áp dụng {{cssxref("box-shadow")}}, `border-radius` là `20px 40px 60px 80px`, và `corner-start-end-shape` là `notch`.
