...
Thuộc tính **`shape-margin`** [CSS](/en-US/docs/Web/CSS) đặt lề cho hình dạng CSS được tạo bằng {{cssxref("shape-outside")}}.
...
Lề cho phép bạn điều chỉnh khoảng cách giữa các cạnh của hình dạng (**phần tử float**) và nội dung xung quanh.
...
- `<length-percentage>`
  - : Đặt lề của hình dạng thành giá trị {{cssxref("&lt;length&gt;")}} hoặc thành {{cssxref("&lt;percentage&gt;")}} của chiều rộng của khối chứa phần tử.
