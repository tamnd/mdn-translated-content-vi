...
Thuộc tính **`border-top-right-radius`** trong [CSS](/en-US/docs/Web/CSS) bo tròn góc trên bên phải của một phần tử bằng cách chỉ định bán kính (hoặc bán trục lớn và bán trục nhỏ) của hình elip định nghĩa độ cong của góc.
...
Độ bo tròn có thể là hình tròn hoặc hình elip, hoặc nếu một trong các giá trị là `0` thì không có bo tròn nào được thực hiện và góc sẽ là góc vuông.
...
> [!NOTE]
> Nếu giá trị của thuộc tính này không được đặt trong thuộc tính viết tắt {{cssxref("border-radius")}} được áp dụng cho phần tử sau thuộc tính CSS `border-top-right-radius`, thì giá trị của thuộc tính này sẽ được đặt lại về giá trị ban đầu của nó bởi [thuộc tính viết tắt](/en-US/docs/Web/CSS/Guides/Cascade/Shorthand_properties).
...
- {{cssxref("border-bottom-right-radius")}}, {{cssxref("border-bottom-left-radius")}}, và {{cssxref("border-top-left-radius")}}
