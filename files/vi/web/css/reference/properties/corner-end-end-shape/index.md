...
Thuộc tính [CSS](/en-US/docs/Web/CSS) **`corner-end-end-shape`** chỉ định hình dạng của góc block-end và inline-end của một hộp, trong phạm vi vùng {{cssxref("border-radius")}} của nó.
...
Thuộc tính `corner-end-end-shape` được chỉ định bằng một giá trị {{cssxref("&lt;corner-shape-value>")}}.
...
### Cách dùng cơ bản của `corner-end-end-shape`
...
Chúng ta cho hộp một số kiểu dáng cơ bản, được ẩn để ngắn gọn. Chúng ta cũng áp dụng {{cssxref("box-shadow")}}, `border-radius` là 60 pixel, và `corner-end-end-shape` là `squircle`.
