...
Các thuộc tính liên quan là {{cssxref("border-block-end-style")}}, {{cssxref("border-inline-start-style")}} và {{cssxref("border-inline-end-style")}}, xác định kiểu viền còn lại của phần tử.
...
- Thuộc tính này ánh xạ tới một trong các thuộc tính viền vật lý: {{cssxref("border-top-style")}}, {{cssxref("border-right-style")}}, {{cssxref("border-bottom-style")}} hoặc {{cssxref("border-left-style")}}.
