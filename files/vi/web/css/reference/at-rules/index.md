---
title: Quy tắc at CSS
short-title: Quy tắc at
...
**Quy tắc at** là các [câu lệnh CSS](/en-US/docs/Web/CSS/Guides/Syntax/Introduction#css_statements) chỉ dẫn CSS cách hoạt động. Chúng được dùng để nhóm và cấu trúc các quy tắc kiểu dáng cùng các quy tắc at khác, khai báo thông tin kiểu không gắn trực tiếp với nội dung được chọn, và quản lý các cấu trúc cú pháp như nhập khẩu (imports) và ánh xạ từ khóa không gian tên (namespace). Chúng bắt đầu bằng ký hiệu at, `@` (U+0040 COMMERCIAL AT), theo sau là một định danh.

## Chỉ mục các quy tắc at và mô tả quy tắc at
...
- {{cssxref("@keyframes")}}
- {{cssxref("@layer")}}
- {{cssxref("@media")}} (xem [danh sách các tính năng media](#chỉ_mục_các_tính_năng_media) ở phần tiếp theo)
- {{cssxref("@namespace")}}
- {{cssxref("@page")}}
...
- [Lồng quy tắc at](/en-US/docs/Web/CSS/Guides/Nesting/At-rules)
- [Cú pháp CSS](/en-US/docs/Web/CSS/Guides/Syntax) module
- [Quy tắc điều kiện CSS](/en-US/docs/Web/CSS/Guides/Conditional_rules) module
