...
[Lớp giả](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-classes) [CSS](/en-US/docs/Web/CSS) **`:last-child`** đại diện cho phần tử cuối cùng trong một nhóm các phần tử anh em.
