...
**`:first-child`** là [lớp giả](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-classes) trong [CSS](/en-US/docs/Web/CSS) đại diện cho phần tử đầu tiên trong một nhóm các phần tử anh chị em.
