...
Công cụ này cho phép bạn nhập hoặc chọn màu, rồi sao chép giá trị tương ứng của nó theo bất kỳ [định dạng màu](/en-US/docs/Web/CSS/Reference/Values/color_value) CSS nào. Bạn có thể sử dụng giá trị màu được tạo ra ở bất cứ nơi nào kiểu dữ liệu {{cssxref("color_value", "&lt;color&gt;")}} được hỗ trợ trong CSS. Công cụ này cũng có thể giúp bạn hiểu cú pháp của các ký hiệu màu khác nhau.

## Cách sử dụng công cụ

Nhập màu theo bất kỳ định dạng nào hoặc chọn màu trong {{glossary("color space")}} sRGB. Bạn cũng có thể điều chỉnh độ trong suốt (alpha channel).

Nhấn nút **Copy** bên cạnh định dạng màu tương ứng để sao chép nhanh giá trị của nó. Bạn cũng có thể nhấn vào tên định dạng màu để tìm hiểu thêm về nó.
...
- [Áp dụng màu sắc với các thuộc tính CSS](/en-US/docs/Web/CSS/Guides/Colors/Applying_color)
...
- [Học: Tạo kiểu nền và đường viền bằng CSS](/en-US/docs/Learn_web_development/Core/Styling_basics/Backgrounds_and_borders)
- [Học về khả năng tiếp cận: Màu sắc và độ tương phản](/en-US/docs/Learn_web_development/Core/Accessibility/CSS_and_JavaScript#color_and_color_contrast)
