...
Công cụ này cho phép bạn pha trộn hai màu trong bất kỳ color space nào bằng hàm {{cssxref("color_value/color-mix")}} và sao chép màu kết quả theo bất kỳ định dạng màu CSS nào.

Hai màu đầu vào, `color-one` và `color-two`, được hiển thị ở hai bên ngoài, và màu pha trộn được trả về bởi hàm được hiển thị ở giữa. Nhấp vào các ô màu bên ngoài để chọn màu mới để pha trộn. Sử dụng các thanh trượt để thay đổi tỉ lệ phần trăm của mỗi màu đầu vào trong hỗn hợp. Sử dụng menu thả xuống để thay đổi color space của đầu ra hàm. Các giá trị của màu kết quả theo các định dạng khác nhau xuất hiện trong bảng phía sau tiện ích và có thể được sao chép. Bạn cũng có thể nhấp vào tên định dạng màu để tìm hiểu thêm về nó.
