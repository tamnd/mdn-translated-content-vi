...
Phần tử **`<annotation-xml>`** [MathML](/en-US/docs/Web/MathML) chứa một chú thích cho biểu thức MathML ở định dạng {{glossary("XML")}}, ví dụ như [Content MathML](https://en.wikipedia.org/wiki/MathML#Content_MathML) hoặc {{glossary("SVG")}}.
...
- `encoding`
  - : Mã hóa của thông tin ngữ nghĩa trong chú thích, ví dụ `"application/mathml+xml"`, `"application/mathml-presentation+xml"`, `"application/mathml-content+xml"`
...
<math display="block">
  <semantics>
    ...
    <!--
      Chú thích bằng Content MathML, một phương ngữ XML chuyên dụng
    ...
    <!-- Chú thích bằng SVG, một định dạng ảnh vector. -->
