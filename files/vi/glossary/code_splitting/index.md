...
**Phân tách code** (code splitting) là việc chia nhỏ code mà một ứng dụng web phụ thuộc vào — bao gồm code của chính nó và bất kỳ phụ thuộc bên thứ ba nào — thành các gói riêng biệt có thể được tải độc lập với nhau.
