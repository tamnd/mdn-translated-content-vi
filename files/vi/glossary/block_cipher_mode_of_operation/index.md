...
**Chế độ hoạt động mã khối** (block cipher mode of operation), thường chỉ được gọi là "chế độ" trong ngữ cảnh, chỉ định cách thức mã khối nên được sử dụng để mã hóa hoặc giải mã các tin nhắn dài hơn kích thước khối.
