...
- [Cover Your Tracks](https://coveryourtracks.eff.org/): công cụ để xem dữ liệu mà trang web có thể sử dụng để lấy dấu vân tay trình duyệt của bạn.
- [Mitigating Browser Fingerprinting in Web Specifications](https://w3c.github.io/fingerprinting-guidance/): các thực hành tốt nhất để các tác giả đặc tả ngăn chặn fingerprinting.
