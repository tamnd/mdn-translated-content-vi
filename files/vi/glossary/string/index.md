...
- [Chuỗi (khoa học máy tính)](<https://en.wikipedia.org/wiki/String_(computer_science)>) trên Wikipedia
- [Các kiểu dữ liệu và cấu trúc dữ liệu JavaScript](/en-US/docs/Web/JavaScript/Guide/Data_structures#string_type)
