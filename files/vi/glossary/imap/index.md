...
Mark Crispin ban đầu phát triển IMAP vào năm 1986 với tên _Interim Mail Access Protocol_. IMAP4 revision 1 là phiên bản hiện tại, được định nghĩa bởi [RFC 3501](https://www.rfc-editor.org/info/rfc3501).
...
- Các thuật ngữ liên quan:
  - {{Glossary("POP")}}
- [IMAP](https://en.wikipedia.org/wiki/Internet_Message_Access_Protocol) trên Wikipedia
