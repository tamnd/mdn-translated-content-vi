...
SDK thường được cung cấp bởi chủ sở hữu của nền tảng phần mềm, để hỗ trợ các nhà phát triển nhắm đến nền tảng đó. Ví dụ, Google cung cấp [Android SDK](https://developer.android.com/studio) cho các nhà phát triển viết ứng dụng Android.

Về nhiều mặt, {{Glossary("developer tools","công cụ dành cho nhà phát triển")}} được tích hợp trong các trình duyệt web hiện đại cung cấp chức năng tương tự cho các nhà phát triển web.
