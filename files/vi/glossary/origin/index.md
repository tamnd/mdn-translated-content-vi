...
- URL `file:` thường được coi là origin mờ đục để các tập tin trên hệ thống tập tin không thể đọc lẫn nhau.
- Các tài liệu được tạo theo chương trình bằng các API như {{domxref("DOMImplementation.createDocument()")}}.

## Ví dụ

Đây là cùng origin vì chúng có cùng scheme (`http`) và hostname (`example.com`), đường dẫn tập tin khác nhau không quan trọng:
