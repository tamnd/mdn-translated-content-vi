...
Cú pháp chỉ điều chỉnh thứ tự và cấu trúc; các lệnh còn phải có _ý nghĩa_, đó là phạm vi của {{Glossary("semantics", "ngữ nghĩa")}}.

Mã phải có cú pháp đúng mới có thể {{Glossary("compile", "biên dịch")}} thành công, nếu không sẽ xảy ra {{Glossary("syntax error", "lỗi cú pháp")}}. Ngay cả những lỗi nhỏ như thiếu dấu ngoặc đơn cũng có thể khiến mã nguồn không thể biên dịch thành công.
...
- [Syntax (programming languages)](<https://en.wikipedia.org/wiki/Syntax_(programming_languages)>) trên Wikipedia
