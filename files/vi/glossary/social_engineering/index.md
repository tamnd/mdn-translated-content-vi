...
Trong bảo mật máy tính, **social engineering** (kỹ thuật xã hội) là kỹ thuật mà kẻ tấn công dùng để thao túng tâm lý người dùng thực hiện các hành động có hại, chẳng hạn như tiết lộ {{glossary("credential","thông tin xác thực")}} hoặc thông tin nhạy cảm khác.

Ví dụ, trong một cuộc tấn công [phishing](/en-US/docs/Web/Security/Attacks/Phishing) (lừa đảo), người dùng nghĩ rằng họ đang đăng nhập vào một trang web mà họ có tài khoản, trong khi thực tế họ đang cung cấp thông tin đăng nhập của mình cho một trang web giả mạo do kẻ tấn công kiểm soát.
