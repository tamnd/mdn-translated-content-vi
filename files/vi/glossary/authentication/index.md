...
Hệ thống {{glossary("Multi-factor authentication", "Xác thực đa yếu tố")}} (MFA) yêu cầu người dùng cung cấp nhiều hơn một yếu tố: ví dụ, mật khẩu kết hợp với mã một lần được tạo ra bằng ứng dụng xác thực trên điện thoại của người dùng.
