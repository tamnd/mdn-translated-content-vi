...
- Nguồn gốc tác giả
  - : Nguồn gốc tác giả là nguồn gốc kiểu dáng chứa tất cả các kiểu là một phần của tài liệu, dù được nhúng trong {{Glossary("HTML")}} hay được tải từ tệp bảng kiểu bên ngoài.
