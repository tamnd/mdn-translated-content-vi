...
Thực hành bổ sung để làm cho một hệ thống dễ bản địa hóa hơn được gọi là {{glossary("Internationalization","quốc tế hóa")}}.

## Xem thêm

- [Localization](https://en.wikipedia.org/wiki/Language_localisation) trên Wikipedia
