...
Tiêu chuẩn web là các quy tắc được thiết lập bởi các tổ chức tiêu chuẩn quốc tế xác định cách {{Glossary("World Wide Web", "Web")}} hoạt động (và đôi khi cũng kiểm soát cả {{Glossary("Internet")}}).
...
- **IETF** (Internet Engineering Task Force): Tiêu chuẩn Internet (STD), trong đó điều chỉnh việc thiết lập và sử dụng {{Glossary("URI", "URI")}}, {{Glossary("HTTP")}}, và {{Glossary("MIME")}}
- **{{Glossary("W3C")}}**: Đặc tả cho ngôn ngữ đánh dấu (ví dụ: {{Glossary("HTML")}}), định nghĩa kiểu dáng (tức là {{Glossary("CSS")}}), {{Glossary("DOM")}}, {{Glossary("Accessibility", "khả năng truy cập")}}
- **IANA** (Internet Assigned Numbers Authority): Các sổ đăng ký tên và số
- **Ecma Intl.:** Tiêu chuẩn scripting, nổi bật nhất là {{Glossary("JavaScript")}}
- **{{Glossary("ISO")}}** (Tổ chức Tiêu chuẩn hóa Quốc tế): Tiêu chuẩn quản lý nhiều khía cạnh đa dạng, bao gồm mã hóa ký tự, quản lý trang web và thiết kế giao diện người dùng
...
- [Tiêu chuẩn web](https://en.wikipedia.org/wiki/Web_standards) trên Wikipedia
