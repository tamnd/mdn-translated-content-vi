...
Khách hàng chỉ định các định dạng họ muốn được gửi trong quá trình [Thương lượng nội dung](/en-US/docs/Web/HTTP/Guides/Content_negotiation) (sử dụng các tiêu đề `Accept-*`), và các representation header cho khách hàng biết định dạng của _biểu diễn đã được chọn_ mà họ nhận được.
