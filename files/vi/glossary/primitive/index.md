...
Trong {{Glossary("JavaScript")}}, **kiểu nguyên thủy** (primitive value, primitive data type) là dữ liệu không phải là {{Glossary("object")}} (đối tượng) và không có {{glossary("method","phương thức")}} hay {{Glossary("property/javascript", "thuộc tính")}}. Có 7 kiểu dữ liệu nguyên thủy:
